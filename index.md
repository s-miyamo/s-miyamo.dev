...
このポートフォリオは、関係者に対して保有スキル等を聞かれた際に提示するために作成致しました。
ポートフォリオを通して私のスキル等を把握して頂き、仕事のアサイン及びアドバイス等を頂くことを目的としています。
また、自分自身のスキル・技術スタックを整理することで、現在不足しているスキル等を把握し今後の方針を定めるためにも使用しています。
